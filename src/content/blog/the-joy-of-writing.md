---
title: "寫作是一件快樂的事：我看鄭緯筌（Vista）老師的《內容感動行銷》"
...
直到參加Vista老師的第二本書《[內容感動行銷](http://bit.ly/vista-content-marketing-book)》新書分享會後，我發現有幾個有趣的觀點分享：

**1\. 寫作是一件快樂的事，不但付出成本較低，還可以隨時練習。**

無論是身在職場上的哪種職務，或許是小編、或許是社群、或許是行銷、或者是業務，構思內容到實際產出的階段，都非常需要寫作的歷練，並且是快速寫作的歷練。而這個能力是平常可以藉由寫[部落格](https://www.contenthacker.today/2019/01/5-blogging-tips-for-newbie-bloggers.html)來訓練，你也可以使用影片、[簡報](https://www.content.tw/content-strategy/how-to-design-a-powerful-presentation)、筆記去輸出你的思考，這都是加強寫作的力量。

**2\. 寫作的「前」與「後」，都有它的脈絡、公式與方法。**

關於**開頭的快速進入與結尾的優雅離開**，這段方法是非常受用的。其中，常常在寫作的文章遇到虎頭蛇尾的狀況，因此如何可以優雅地結尾，可能就有包含前後呼應、移位解說、期望行動等方式。這樣的操作方式，我相信也是Vista老師多年的寫作經驗所歸納的要素。

總而言之，誠摯推薦《[內容感動行銷](http://bit.ly/vista-content-marketing-book)》一書！
